...
if ($_GET[modul]=='beranda'){
  ...
  echo "  SPK Penerimaan Siswa Baru SMA 'SMARTER'.<br>
		   Silahkan klik menu pilihan yang berada 
          di sebelah atas untuk mengelola content website. </p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
...
// Bagian Modul
elseif ($_GET[modul]=='subkriteria'){
  include "modul_admin/mod_subkriteria/subkriteria.php";
}
